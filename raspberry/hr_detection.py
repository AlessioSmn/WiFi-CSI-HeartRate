...
MODEL_PATH = f"models/csi_hr_best_{SEGMENTATION_WINDOW_LENGTH}.keras"  # path of the model to be loaded
...
def prediction_process(q_in, q_out, stop_event):
    """Run Keras inference on windows."""
